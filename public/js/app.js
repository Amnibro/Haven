...
import UIBindMethods   from './modules/app-ui.js?v=4.6.9';
...
import MessageMethods  from './modules/app-messages.js?v=4.6.9';
...
import ForumMethods    from './modules/app-forum.js?v=4.6.9';
