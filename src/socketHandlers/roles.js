...
module.exports = function register(socket, ctx) {
  ...
  socket.on('reset-roles-to-default', (data, callback) => {
    ...
    try {
      ...
      ['kick_user','mute_user','delete_message','pin_message','set_channel_topic','manage_sub_channels','rename_channel','rename_sub_channel','delete_lower_messages','manage_webhooks','use_ferry','upload_files','use_voice','view_history','view_all_members','manage_music_queue','manage_tags','delete_own_messages','edit_own_messages']
